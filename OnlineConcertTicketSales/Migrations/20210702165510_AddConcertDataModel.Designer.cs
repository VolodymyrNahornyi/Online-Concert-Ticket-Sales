...
namespace OnlineConcertTicketSales.Migrations
{
    ...
    [Migration("20210702165510_AddConcertDataModel")]
    partial class AddConcertDataModel
    {
            ...
            modelBuilder.Entity("Entities.Models.Concerts.Concert", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2021, 2, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6156)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 3, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6429)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 4, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6441)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 6, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6446)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 8, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6451)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 9, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6455)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 4, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6459)
                        },
                        new
                        {
                            ...
                            ArtistId = new Guid("f32cba10-8b39-430b-904e-1013ce10bd7e"),
                            ConcertName = "Queen I",
                            Date = new DateTime(2021, 5, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6464)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 6, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6468)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 7, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6473)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 8, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6477)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 9, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6482)
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2021, 10, 2, 19, 55, 10, 375, DateTimeKind.Local).AddTicks(6486)
                        });
                });
