...
public class Entity : DynamicObject, IXmlSerializable, IDictionary<string, object>
    {
        ...
        private void WriteLinksToXml(string key, object value, XmlWriter writer)
        {
            ...
            if (value.GetType() == typeof(System.Collections.Generic.List<Link>))
            {
                foreach (var val in value as System.Collections.Generic.List<Link>)
                {
        ...
        public IEnumerator<System.Collections.Generic.KeyValuePair<string, object>> GetEnumerator()
        {
